    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12">
          ...
          <h2 className="banner-title">Left Sidebar</h2>
          <div className="bread-crumb"><a href="#">Home</a> / <a href="#">Products</a> / Left Sidebar</div>
        </div>
      </div>
    </div>
  </section>
      ...
      <div className="col-lg-2">
        <div className="shop-sidebar">
          <aside className="widget widget-categories">
            ...
            <ul>
              <li><a href="#">SmartPhones</a><i className="twi-angle-down1" /></li>
              <li><a href="#">Computers</a><i className="twi-angle-down1" /></li>
              <li><a href="#">Smart Watch</a><i className="twi-angle-down1" /></li>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="single-shop-product">
              <div className="sp-thumb">
                <img src="assets/images/shop/7.jpg" alt="" className />
        ...
        <div className="row">
          <div className="col-lg-10 offset-lg-1 col-md-12 mt-20">
            <div className="goru-pagination text-center clearfix">
              <a className="prev" href="#"><i className="twi-long-arrow-left"  alt=""/></a>
              <span className="current">1</span>
              <a href="#">2</a>
              <a href="#">3</a>
              <a href="#">4</a>
              <a href="#">5</a>
              <a className="next" href="#"><i className="twi-long-arrow-right" alt="" /></a>
            </div>
          </div>
        </div> 
      </div>
